                ...
                <div className="container">
                    <div className='d-flex justify-between items-center'>
                        ...
                        <ul className='gap-46 d-flex  small-screen'>
                            <li><a href="" className='text-black ff-work fs-base text-normal'>Home</a></li>
                            <li><a href="" className='text-black ff-work fs-base text-normal'>Modules</a></li>
                            <li><a href="" className='text-black ff-work fs-base text-normal'>Pricing</a></li>
                            <li><a href="" className='text-black ff-work fs-base text-normal'>Features</a></li>
                            <li><a href="" className='text-black ff-work fs-base text-normal'>Contact Us</a></li>
